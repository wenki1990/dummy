Investigating the relationship between World Development Indicators(WDI) and the severity of the COVID-19 pandemic through Data Mining
...
Table 1.3: Clusters from K-Means Clustering
