...
[Click here for Code Implementation update link to code directory](Code%20Implementation)
...
1. [Bounding Boxes](#bounding-boxes)
2. [Intersection over Union (IoU)](#intersection-over-union-(iou))
3. [Non-max Suppression](#non-max-suppression)
4. [Anchor Boxes](#anchor-boxes)
5. [Bringing it all together](#bringing-it-all-together)

[YOLOv3 Architecture](#yolov3-architecture)

<a name = "use-cases"></a><h4>Use Cases</h4>

- Object Detection for self-driving motorcycle in my village <h1>&#128540;</h1>

<center><img src="readme_images/video.gif" width = 700 height = 400></center>

<center><img src="readme_images/frames.gif" width = 700 height = 400></center><p style="text-align:left;"><em>Note: clideo.com was used to extract image sequence from the video</em></p>
...
<a name = "bounding-boxes"></a><h4>1. Bounding Boxes</h4>
...
<a name = "non-max-suppression"></a><h4>3. Non-max Suppression</h4>
...
<a name = "anchor-boxes"></a><h4>4. Anchor Boxes</h4>
...
<a name = "bringing-it-all-together"></a><h4>5. Bringing it all together</h4>
...
<a name = "yolov3-architecture"></a><h3>YOLOv3 Architecture</h3>
...
[Code Implementation update link to code directory](Code%20Implementation)
